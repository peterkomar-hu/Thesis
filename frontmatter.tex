...
physical science. This thesis presents an analysis of several new model systems
...
atoms with optical photons, and investigate the possibility of using them to
 store information robustly and as relay nodes.
...
entanglement protocols employing this robust gate, and we use these systems to
...
quantum unison. We show that by creating a cascade of independent Greenberger-Horne-Zeilinger states 
...
Johannes \mbox{Borregaard}, and Eric Kessler; besides many years of fruitful
...
Zeigler, for facilitating my stay at Harvard.
...
Finally, I would like to thank my family, Erzs\'{e}bet and Antal
