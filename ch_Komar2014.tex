...
\reffig{fig:security}b and Appendix \ref{app:Security_countermeasures}). As a result, even if  all LO signals are intercepted, the eavesdropper is able to access
