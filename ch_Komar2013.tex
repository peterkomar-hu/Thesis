...
We consider the setup shown schematically in \reffig{fig:cartoon}(a), consisting
...
% ==================================
\begin{figure}[htb]
\includegraphics[width=0.45\textwidth]{./fig1a.pdf} \\[0.5cm]
...
\reffig{fig:spectrum}(a) and (b) we show the 
...
\begin{figure}[tb]
\centering
  \includegraphics[width=0.4\textwidth]{./fig2a.pdf}\\[-0.8cm]
  \includegraphics[width=0.4\textwidth]{./fig2b.pdf}\\[-0.8cm]
  \includegraphics[width=0.4\textwidth]{./fig2c.pdf}\\[0.3cm]
  \includegraphics[width=0.4\textwidth]{./fig2d.pdf}
  \caption{
...
%  Normalized average photon number 
%  \sdb{(dashed green line, numerics with
%  ``+")} and photon-photon correlation function
%  \sdb{(solid blue line, numerics with ``o")} for driven mode $c_a$
%  as a function of laser detuning at zero temperature.
...
$\bar n_R = \ev{c_R\+ c_R}$
is plotted in \reffig{fig:spectrum}(c).
...
at the same time.
The solid curves in \reffig{fig:spectrum} show $g^{(2)}_{aa}(0)$,
...
six levels shown in \reffig{fig:cartoon}(b).
...
the features seen in the numerical results in \reffig{fig:spectrum}.
...
At first glance,
the level diagram in \reffig{fig:cartoon} together with
bunching 
in \reffig{fig:spectrum}(a) 
...
(see point D in \reffig{fig:spectrum}),
where
...
\begin{figure}[htb] 
\centering
  \includegraphics[width=0.43\textwidth]{./fig3.pdf}
  \caption{
  ...
  Parameters are the same as in \reffig{fig:spectrum},
...
g\sqrt{\frac{n+2}{2}}A_{0,2,n+2} \quad\nonumber\\
...
In \reffig{fig:thermal_g2} we plot the correlation functions,
...
one- and two-photon manifolds as indicated in \reffig{fig:thermal_g2}(a).
...
\centering
  ...
  \includegraphics[width=0.43\textwidth]{./fig4c.pdf}
  \caption{
...
\begin{figure}[tb] \centering
  \includegraphics[width=0.50\textwidth]{./fig5a.pdf}\\[-0.5cm]
  \includegraphics[width=0.50\textwidth]{./fig5b.pdf}
  \caption{
  ...
  \text{ (E)}$.
  Detuning for curve A is the same as marked in \reffig{fig:spectrum},
